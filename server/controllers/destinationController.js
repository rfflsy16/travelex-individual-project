...
class DestinationController {
    ...
    static async recomendation(req, res, next) {
        try {
            ...
            const promptBeach = "Kasih saya 10 rekomendasi destinasi apa yang paling ngehits ini di kategori pantai, gunung, pulau, kota wisata, Sejarah & budaya, Petualangan, Taman Nasional, Kuliner dan tolong kelompokan berdasarkan kategori di atas dan berikan dalam bentuk json tanpa tag json dan tanpa enter";
